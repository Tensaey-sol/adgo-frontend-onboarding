...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => {
  return (
    <div className="flex flex-col w-full max-md:w-full">
      <article className="flex flex-col items-start text-gray-800 max-md:mt-6">
        ...
        <p className="self-stretch mt-2 text-base leading-7 opacity-70">{description}</p>
      </article>
    </div>
  );
};
...
const HowWeWork: React.FC = () => {
  return (
    <section className="flex flex-col rounded-none">
      <div className="flex flex-col justify-center items-center px-20 py-40 w-full bg-slate-100 max-md:px-5 max-md:py-24 max-md:max-w-full">
        <div className="flex flex-col mb-0 w-full max-w-[1178px] max-md:mb-2.5 max-md:max-w-full">
          <div className="flex gap-5 max-md:flex-col">
            <div className="flex flex-col w-[34%] max-md:w-full mr-auto">
              <header className="flex flex-col text-gray-800 max-md:mt-10">
